...
NotEnoughPlayers = Not enough players (11 minimum)
TooMuchPlayers = Too much players (16 maximum)
...
PlayersMustMatchTeamVersion = Players must match the team version
...
Scheduled = Scheduled
PreGameSequence = Pre-game sequence in progress
GameInProgress = Game in progress
PostGameSequence = Post-game sequence in progress
...
ChosenSkill = Chosen Skill ({ $skill })
RandomSkill = Random Skill ({ $skill })
MovementAllowance = Movement Allowance
Strength = Strength
Agility = Agility
PassingAbility = Passing Ability
ArmourValue = Armour Value
...
MesmerizingGaze = Mesmerizing Gaze
...
DwarvenScourge = Dwarven Scourge
...
KickThemWhileTheyAreDown = Kick 'em While They're Down!
